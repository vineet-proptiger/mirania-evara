      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 bg-white transition-shadow duration-300 ${scrolled ? 'shadow-md' : 'shadow-sm'}`}>
        ...
        <div className="container mx-auto px-4 md:px-8 flex items-center justify-between h-[80px]">
          <Link href="/" className="flex items-center">
            <img src={logoImages.tarc} alt="Mirania Evara" className="h-10 sm:h-14 w-auto object-contain" />
          </Link>
          <Link
            href="/"
        ...
        >
          ...
          >
            ...
            <p className="mb-6 sm:mb-8 text-sm sm:text-base" style={{ lineHeight: 1.8, color: '#444', fontFamily: 'var(--font-jost), Jost, sans-serif' }}>
              At <strong style={{ color: 'var(--color-gold-dark)', fontWeight: '600' }}>Mirania Evara</strong> (Authorized Marketing Partner), we respect your privacy and are committed to safeguarding your personal data. This Privacy Policy outlines how we collect, use, and protect your information when you visit our website.
            </p>
