        ...
        <div style={{
          ...
          <div style={{ padding: '24px 28px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <p style={{ color: '#555', fontFamily: F_SANS, lineHeight: 1.85, fontSize: '14px', margin: '0 0 20px' }}>
              Mirania Evara is crafted by a developer committed to excellence, innovation, and trust. Rising on EM Bypass in Mukundapur, Kolkata, this exclusive single-tower project redefines luxury living with just 86 premium 3 &amp; 4 BHK homes, rooftop amenities, and future-ready features—built for those who seek the finest in urban comfort.</p>
