...
const locationCategories = [
  {
    ...
    items: [
      { name: 'Calcutta International School', time: '2 km' },
      { name: 'Delhi Public School, Ruby Park', time: '3 km' },
      { name: 'South Point High School', time: '6 km' },
      { name: 'Heritage Institute of Technology', time: '3 km' },
    ],
  },
  {
    title: 'Hospitals',
    ...
    items: [
      { name: 'Ruby General Hospital', time: '2 km' },
      { name: 'Desun Hospital', time: '2.5 km' },
      { name: 'AMRI Hospital, Mukundapur', time: '3 km' },
      { name: 'Fortis Hospital, Anandapur', time: '4 km' },
    ],
  },
  {
    title: 'Food & Shopping',
    ...
    items: [
      { name: 'Acropolis Mall', time: '3 km' },
      { name: 'Metropolis Mall, Hiland Park', time: '2 km' },
      { name: 'South City Mall', time: '6 km' },
      { name: 'Quest Mall', time: '8 km' },
    ],
  },
  {
    ...
    items: [
      { name: 'EM Bypass', time: '1 km' },
      { name: 'Salt Lake Sector V', time: '9 km' },
      { name: 'Major IT & Commercial Hub', time: '6–8 km' },
      { name: 'Upcoming Metro Connectivity', time: 'Nearby' },
    ],
  },
  {
    ...
    items: [
      { name: 'Sealdah Railway Station', time: '8 km' },
      { name: 'Howrah Railway Station', time: '14 km' },
      { name: 'Netaji Subhash Chandra Bose Airport', time: '18 km' },
      { name: 'Upcoming Metro Station', time: '2 km' },
    ],
  },
]
    ...
    <section id="location" style={{
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div style={{ marginBottom: '36px', textAlign: 'center' }} data-aos="fade-up">
          ...
          }}>EM Bypass, Mukundapur, Kolkata</span>
          <h2 style={{
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          ...
          {/* RIGHT — Map */}
          <div className="w-full lg:flex-1 lg:sticky lg:top-[100px]" data-aos="fade-left">
            <div style={{
              ...
              <iframe
                title="Mirania Evara Location Map"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3038.271132754167!2d88.397649!3d22.495039900000002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a02710043158787%3A0xc0555bd6a68b81e2!2sMirania%20Evara!5e1!3m2!1sen!2sin!4v1778738431925!5m2!1sen!2sin"
