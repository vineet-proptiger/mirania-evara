...
import { BedDouble, MapPin, Building2, Navigation, TrendingUp, Sparkles } from 'lucide-react'
...
const highlights = [
  {
    text: 'Elegant single-tower luxury residences on EM Bypass with just 86 exclusive homes.',
    icon: <BedDouble {...highlightIconProps} />,
  },
  {
    text: 'Panoramic skyline views with 50% open space & sky balconies for refreshing living.',
    icon: <Building2 {...highlightIconProps} />,
  },
  {
    text: 'Prime Metro-adjacent location—opposite Metro Cash & Carry with unmatched connectivity.',
    icon: <MapPin {...highlightIconProps} />,
  },
  {
    text: 'World-class rooftop and lifestyle amenities including infinity pool & wellness spaces.',
    icon: <Sparkles {...highlightIconProps} />,
  },
  {
    text: 'Future-ready living with EV charging, smart security & modern lifestyle features.',
    icon: <TrendingUp {...highlightIconProps} />,
  },
  {
    text: 'Excellent access to top hospitals, reputed schools, shopping and business hubs.',
    ...
    <div className="container mx-auto px-4 md:px-8">
      ...
      <div style={{ textAlign: 'center', marginBottom: '40px' }} data-aos="fade-up">
        ...
        <h2 style={{
          ...
          Highlights Gallery:{' '}
          <span style={{ color: 'var(--color-gold)' }}> Mirania Evara</span>
        </h2>
